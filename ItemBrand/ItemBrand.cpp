...
ItemBrand::Add(const std::vector<std::string> &fields,
...
ItemBrand::GetAll(const std::vector<std::string> &fields) const {
  try {
...
omnisphere::models::ItemBrand
ItemBrand::Get(const std::vector<std::string> &fields,
  ...
  try {
    ...
    return omnisphere::data::MapFromRow<omnisphere::models::ItemBrand>(
        dataTable[0]);
  } catch (const std::exception &e) {
