...
{
    class UpdateCustomer : public omnisphere::models::BaseModel
    {
        public:
        UpdateCustomer(int _Entry, std::string _Code, std::string _Name,
            ...
            TaxID(std::move(_TaxID)), Email(std::move(_Email)), Phone(std::move(_Phone)),
