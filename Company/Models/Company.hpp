...
namespace omnisphere::models
{
    class Company : public omnisphere::models::BaseModel
    {
        ...
        Company(int _Entry, std::string _Code, std::string _Name,
                ...
                std::optional<std::string> _ImagePath, std::string _IsActive,
                int _CreatedBy, std::string _CreateDate,
                std::optional<int> _LastUpdatedBy, std::optional<std::string> _UpdateDate)
            ...
            Address(std::move(_Address)), Address2(std::move(_Address2)), City(_City),
            State(_State), ZipCode(_ZipCode), Country(_Country),
            TaxID(std::move(_TaxID)), Currency(_Currency), Phone1(std::move(_Phone1)),
            Phone2(std::move(_Phone2)), Email(std::move(_Email)),
            WebSite(std::move(_WebSite)), FacebookProfile(std::move(_FacebookProfile)),
            ...
            ImagePath(std::move(_ImagePath)), CommercialName(std::move(_CommercialName)),
