...
bool Company::Create(const omnisphere::dtos::CreateCompany &_company) const {
  try {
    ...
    AddInsertParam("CommercialName", _company.CommercialName, insertClauses,
                   params);
    ...
    AddInsertParam("FacebookProfile", _company.FacebookProfile, insertClauses,
                   params);
    AddInsertParam("InstagramProfile", _company.InstagramProfile, insertClauses,
                   params);
...
bool Company::Update(const omnisphere::dtos::UpdateCompany &_company) const {
  try {
    ...
    AddSetParam("FacebookProfile", _company.FacebookProfile, setClauses,
                params);
    AddSetParam("InstagramProfile", _company.InstagramProfile, setClauses,
                params);
    AddSetParam("XProfile", _company.XProfile, setClauses, params);
    AddSetParam("LogoFile", _company.LogoFile, setClauses, params);
    AddSetParam("IsActive", _company.IsActive, setClauses, params);
