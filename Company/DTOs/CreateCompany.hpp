...
{
    class CreateCompany : public omnisphere::models::BaseModel
    {
        public:
        CreateCompany(int _Entry, std::string _Code, std::string _Name,
                      ...
                      std::optional<std::string> _ImagePath, int _CreatedBy,
