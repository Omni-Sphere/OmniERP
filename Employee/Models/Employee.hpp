...
namespace omnisphere::models
{
    ...
    {
        public:
        Employee(int _Entry, std::string _Code, std::string _Name,
                 std::string _FirstName, std::optional<std::string> _SecondName,
                 ...
                 std::optional<std::string> _Comments, bool _IsActive, int _CreatedBy,
