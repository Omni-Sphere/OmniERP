...
public:
  ...
  Add(const omnisphere::dtos::CreateEmployee &employee) const;
  omnisphere::models::Employee
  Modify(const omnisphere::dtos::UpdateEmployee &employee) const;
  std::vector<omnisphere::models::Employee> GetAll() const;
  omnisphere::models::Employee
  Get(const omnisphere::dtos::GetEmployee &getEmployee) const;
