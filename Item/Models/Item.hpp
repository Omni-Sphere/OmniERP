...
public:
  Item(int _Entry, std::string _Code, std::string _Name,
       ...
       std::optional<std::string> _Image, bool _IsActive, bool _PurchaseItem,
       bool _SellItem, bool _InventoryItem, double _Price,
       std::optional<int> _Brand, std::optional<int> _Group, double _OnHand,
       std::optional<double> _OnOrder, std::optional<double> _OnRequest,
       std::optional<double> _MinStock, std::optional<double> _MaxStock,
       std::optional<double> _MinOrder, std::optional<double> _MaxOrder,
       std::optional<double> _MinRequest, std::optional<double> _MaxRequest,
      ...
      : BaseModel(_Entry, std::move(_Code), std::move(_Name), _CreatedBy,
        ...
        Group(_Group), OnHand(_OnHand), OnOrder(_OnOrder),
        OnRequest(_OnRequest), MinStock(_MinStock), MaxStock(_MaxStock),
