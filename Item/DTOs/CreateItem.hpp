...
BOOST_DESCRIBE_STRUCT(CreateItem, (),
                      (Code, Name, Description, Image, PurchaseItem, SellItem,
                       InventoryItem, Price, Brand, Group, MinStock, MaxStock,
                       MinOrder, MaxOrder, MinRequest, MaxRequest, CreatedBy,
                       CreateDate))
} // namespace omnisphere::dtos
