...
public:
  ...
  Store(int _Entry, std::string _Code, std::string _Name, int _GuestCustomer,
        ...
        std::optional<std::string> _TicketsPath, bool _IsActive, int _CreatedBy,
...
BOOST_DESCRIBE_STRUCT(Store, (),
                      (Entry, Code, Name, GuestCustomer, Address, Address2,
                       City, State, ZipCode, Country, TaxID, Currency, Phone1,
                       Phone2, Email, WebSite, FacebookProfile,
                       InstagramProfile, XProfile, LogoFile, ImagePath,
                       ReportsPath, TicketsPath, IsActive, CreatedBy,
