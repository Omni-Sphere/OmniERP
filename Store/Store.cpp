...
std::optional<omnisphere::models::Store>
Store::Get(const omnisphere::dtos::GetStore &filter,
...
std::vector<omnisphere::models::Store>
Store::GetAll(const std::vector<std::string> &fields) const {
  ...
  for (int i = 0; i < dataTable.RowsCount(); i++) {
    results.emplace_back(
        omnisphere::data::MapFromRow<omnisphere::models::Store>(dataTable[i]));
  }
