...
struct CreateStore : public omnisphere::dtos::BaseCreateDTO {
  CreateStore(std::string _Code, std::string _Name,
              ...
              std::optional<int> _Currency, std::optional<std::string> _Phone1,
              ...
              std::optional<std::string> _TicketsPath, int _CreatedBy,
...
BOOST_DESCRIBE_STRUCT(CreateStore, (),
