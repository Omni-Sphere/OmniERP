...
struct UpdateStore : public omnisphere::dtos::BaseUpdateDTO {
  UpdateStore(
      int _Entry, std::optional<std::string> _Code,
      std::optional<std::string> _Name, std::optional<int> _GuestCustomer,
      std::optional<std::string> _Address, std::optional<std::string> _Address2,
      std::optional<int> _City, std::optional<int> _State,
      std::optional<int> _ZipCode, std::optional<int> _Country,
      std::optional<std::string> _TaxID, std::optional<int> _Currency,
      std::optional<std::string> _Phone1, std::optional<std::string> _Phone2,
      std::optional<std::string> _Email, std::optional<std::string> _WebSite,
      ...
      std::optional<std::string> _TicketsPath, std::optional<bool> _IsActive,
      int _LastUpdatedBy, std::string _UpdateDate)
      : omnisphere::dtos::BaseUpdateDTO("", "", _LastUpdatedBy,
        ...
        ZipCode(_ZipCode), Country(_Country), TaxID(std::move(_TaxID)),
        Currency(_Currency), Phone1(std::move(_Phone1)),
        Phone2(std::move(_Phone2)), Email(std::move(_Email)),
        ...
        ImagePath(std::move(_ImagePath)), ReportsPath(std::move(_ReportsPath)),
        TicketsPath(std::move(_TicketsPath)), IsActive(_IsActive) {}
...
BOOST_DESCRIBE_STRUCT(UpdateStore, (),
                      (Code, Name, GuestCustomer, Address, Address2, City,
                       State, ZipCode, Country, TaxID, Currency, Phone1, Phone2,
                       Email, WebSite, FacebookProfile, InstagramProfile,
                       XProfile, LogoFile, ImagePath, ReportsPath, TicketsPath,
                       IsActive))
} // namespace omnisphere::dtos
