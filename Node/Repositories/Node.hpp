...
namespace omnisphere::repositories
{
    class Node
    {
        ...
        static omnisphere::enums::OperationMode CharToOperationMode(const std::string& str);
        static std::string OperationModeToChar(omnisphere::enums::OperationMode mode);
        static omnisphere::models::Node MapNodeRow(omnisphere::types::DataTable::Row& row);

        bool Create(const omnisphere::dtos::CreateNode &_node) const;
        bool Update(const omnisphere::dtos::UpdateNode &_node) const;
        omnisphere::types::DataTable Read(const omnisphere::dtos::GetNode &filter, const std::vector<std::string>& fields = {}) const;
        omnisphere::types::DataTable ReadAll(const std::vector<std::string>& fields = {}) const;
        omnisphere::types::DataTable Search(const std::vector<std::string>& fields, const omnisphere::dtos::SearchNode &filter) const;
