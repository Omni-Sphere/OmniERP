...
public:
  ...
  Node(int _Entry, std::string _Code, std::string _Name,
       omnisphere::enums::NodeType _NodeType,
       omnisphere::enums::OperationMode _OperationMode,
       std::optional<int> _CashLimit, std::optional<std::string> _IPAddress,
       bool _ExtendedLog, bool _IsActive, int _CreatedBy,
      ...
      : Entry(_Entry), Code(std::move(_Code)), Name(std::move(_Name)),
        NodeType(_NodeType), OperationMode(_OperationMode),
        CashLimit(_CashLimit), IPAddress(std::move(_IPAddress)),
        ExtendedLog(_ExtendedLog), IsActive(_IsActive), CreatedBy(_CreatedBy),
        CreateDate(std::move(_CreateDate)), LastUpdatedBy(_LastUpdatedBy),
  ...
  omnisphere::enums::OperationMode OperationMode =
      omnisphere::enums::OperationMode::POS;
...
BOOST_DESCRIBE_STRUCT(Node, (),
                      (Entry, Code, Name, NodeType, OperationMode, CashLimit,
                       IPAddress, ExtendedLog, IsActive, CreatedBy, CreateDate,
