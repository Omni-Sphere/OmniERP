...
public:
  ...
  std::vector<omnisphere::models::Floor> GetAll(const std::vector<std::string>& fields = {}) const;
  omnisphere::models::Floor
  Get(const omnisphere::dtos::GetFloor &getFloor, const std::vector<std::string>& fields = {}) const;
