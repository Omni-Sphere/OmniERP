...
namespace omnisphere::rolepermission
{
    ...
    std::vector<omnisphere::models::RolePermission> RolePermission::GetAll() const
    {
        ...
        {data[i]["Entry"], data[i]["RoleEntry"], data[i]["PermissionEntry"], data[i]["IsActive"], data[i]["CreatedBy"], data[i]["CreateDate"], data[i]["LastUpdatedBy"].GetOptional<int>(), data[i]["UpdateDate"].GetOptional<std::string>()});
    ...
    omnisphere::models::RolePermission RolePermission::Get(const omnisphere::dtos::GetRolePermission& getRolePermission) const
    {
        ...
        {data[0]["Entry"], data[0]["RoleEntry"], data[0]["PermissionEntry"], data[0]["IsActive"], data[0]["CreatedBy"], data[0]["CreateDate"], data[0]["LastUpdatedBy"].GetOptional<int>(), data[0]["UpdateDate"].GetOptional<std::string>()};
    }
