...
public:
  ...
  ~RolePermission();
  omnisphere::models::RolePermission
  Add(const omnisphere::dtos::CreateRolePermission &rolePermission) const;
  omnisphere::models::RolePermission
  Modify(const omnisphere::dtos::UpdateRolePermission &rolePermission) const;
  std::vector<omnisphere::models::RolePermission> GetAll() const;
  omnisphere::models::RolePermission
  Get(const omnisphere::dtos::GetRolePermission &getRolePermission) const;
